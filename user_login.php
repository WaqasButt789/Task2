...
*/
   public function login_for_user($data){

      if(self::user_log($data))
      {
        echo json_encode(array('Message'=>'User successfuly login','status'=>"409"));  

      }
      else{

        echo json_encode(array("Messsage"=>"your email or password is incorrect"));
      }
...
{
    $obj->trim_data($p1);
    $obj->login_for_user($p1);
}
else{
    echo json_encode(array("Error Message"=>"Please Enter Valid Data")) ;
}
